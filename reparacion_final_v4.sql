-- ============================================================
-- 🚀 REPARACIÓN DEFINITIVA DE DATOS CRUZADOS (V4)
-- ============================================================
...
-- 2. Limpieza recursiva de clientes y chats duplicados
DO $$
DECLARE
...
BEGIN
    ...
    -- A. DEDUPLICAR CLIENTES (customers)
    ...
    LOOP
        ...
        IF v_good_customer_id IS NOT NULL THEN
            -- Caso duplicado:
            -- 1. Redirigir chats que apunten al cliente malo hacia el cliente bueno
            UPDATE public.whatsapp_chats SET customer_id = v_good_customer_id WHERE customer_id = r_bad_customer.id;
            -- 2. Redirigir pedidos y reservas al cliente bueno
    ...
    -- C. ASIGNAR TENANT A MENSAJES RESTANTES
