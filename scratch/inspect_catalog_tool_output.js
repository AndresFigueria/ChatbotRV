...
try {
  ...
  if (row && row.data) {
    ...
    if (runData && runData['Consultar Catálogo']) {
      console.log("=== CONSULTAR CATALOGO OUTPUT IN 470 ===");
      console.log(JSON.stringify(runData['Consultar Catálogo'][0], null, 2));
    } else {
      console.log("No Consultar Catálogo output found.");
    }
  } else {
