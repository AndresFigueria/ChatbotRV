...
try {
  ...
  if (row) {
    ...
    const nodeIdx = parseInt(runDataHeader['Guardar Mensaje Cliente'], 10);
    console.log("=== GUARDAR MENSAJE CLIENTE RESOLVED DATA ===");
    console.log(JSON.stringify(resolveDeep(arr[nodeIdx]), null, 2));
  }
} catch (err) {
  console.error(err);
}
